...
13. If this diff is DELEGATE-origin and touches settlement rules, EEG provisions, or ENTSO-E field semantics, is there a cited source (spec, ENTSO-E documentation, EEG text) confirming it was verified rather than just plausible-sounding?
